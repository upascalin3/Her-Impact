import { GraduationCap, ArrowLeft, BookOpen, Calendar, User } from "lucide-react";
    ...
    <main className="min-h-screen bg-[#0a0f1f] text-white">
        ...
        <div className="relative container-page">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <h1 className="section-title text-4xl md:text-5xl">Education & Learning</h1>
            </div>
          </div>
          <p className="body-text text-[#c9d4ff] text-lg max-w-3xl mb-8">
            Hands-on tutorials, study resources, and learning tools for all ages. Discover educational content, courses, and resources to advance your STEM knowledge and skills.
          </p>
        </div>
      </section>
      ...
      <section className="bg-[#070b16] py-20">
        <div className="container-page">
          <h2 className="section-title text-3xl mb-10">Learning Resources</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                date: "March 21, 2024",
                excerpt: "Learn Python programming specifically for data analysis and visualization."
              },
              {
                title: "Quantum Computing Basics",
                author: "Dr. Priya Sharma",
                date: "March 17, 2024",
                excerpt: "An introduction to quantum computing concepts and their real-world applications."
              }
            ].map((resource, i) => (
