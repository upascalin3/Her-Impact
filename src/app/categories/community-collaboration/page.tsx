import { Users2, ArrowLeft, BookOpen, Calendar, User } from "lucide-react";
    ...
    <main className="min-h-screen bg-[#0a0f1f] text-white">
        ...
        <div className="relative container-page">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <h1 className="section-title text-4xl md:text-5xl">Community & Collaboration</h1>
            </div>
          </div>
          <p className="body-text text-[#c9d4ff] text-lg max-w-3xl mb-8">
            Global networks and projects uniting women in STEM. Connect with like-minded individuals, collaborate on projects, and build meaningful professional relationships.
          </p>
        </div>
      </section>
      ...
      <section className="bg-[#070b16] py-20">
        <div className="container-page">
          <h2 className="section-title text-3xl mb-10">Community Projects</h2>
            ...
            {[
              {
                ...
                date: "March 28, 2024",
                excerpt: "Connecting experienced professionals with emerging talent across the globe."
              },
              {
                title: "Women in AI Research Collaboration",
                author: "Dr. Sarah Chen",
                date: "March 24, 2024",
                excerpt: "A collaborative research initiative advancing AI ethics and inclusion."
              },
              {
                title: "STEM Education Outreach Program",
                author: "Dr. Maria Santos",
                date: "March 20, 2024",
                excerpt: "Bringing STEM education to underserved communities worldwide."
              }
            ].map((project, i) => (
              <article key={project.title} className="card-glow p-6 reveal">
                <div className="h-40 bg-gradient-to-tr from-[#f48fb1]/40 to-[#79a1ff]/30 rounded-xl mb-4" />
                <h3 className="subheading text-xl mb-2">{project.title}</h3>
                <p className="body-text text-white/70 mb-4">{project.excerpt}</p>
